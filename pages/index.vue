    ...
    <v-container fluid>
      ...
      <v-row>
        <v-col align-self="center" cols="12" lg="6">
          ...
          <v-btn class="ml-lg-10" style="border: 2px solid #96bbcf" rounded color="#2d779f" dark>
            Discover
          </v-btn>
        </v-col>
        <v-col align-self="center" cols="12" lg="6">
          <v-row>
            <v-col
              ...
              sm="6"
            >
              <v-img width="60%" class="mx-auto" src="/eagle.png" />
            ...
            <v-col
              ...
              sm="6"
            >
              <v-img width="60%" class="mx-auto" src="/orange_circle-2.png" />
              <p class="subtitle-2 text-center">
                One Tech
              </p>
            </v-col>
